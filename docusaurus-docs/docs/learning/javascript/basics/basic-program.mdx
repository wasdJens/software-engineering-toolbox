...
- Die kennen gelernten Konzepte anwenden

## Guessing Game

- Bitte ignorieren sie `async / await` und die `package.json` Datei (Diese Konzepte werden später vorgestellt)
- Source Code https://github.com/wasdJens/dhbw-webprogrammierung-wwi/tree/master/js-basics/JS-Program
